...
洋紅底拆件批次(Gemini / NB2 edit,6 張):

![a3 洋紅拆件批次](images/a3-batch-magenta.png)

場景填補批次(NB2「依照原圖構圖色調材質 填補」,另一工作流,成功率未評):

![a3 場景填補批次](images/a3-batch-scene-fill.png)
...
| 背景小樹 · 緊裁後 | 主體判別 **3/3**;全淨一次過 1/3 | 右場景 1 次過;左場景 2 張留遮擋幹但與主體分離 → 手動填色可救 |
| 洋紅批次縮圖總覽(6 張) | 全淨 ≈1 / 手動可救 ≈3 / 場景殘留重跑 ≈2 | 縮圖概判,以「可入下一工序」計約 **4/6** |
