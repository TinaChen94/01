...
| **B7 三相機 → Unreal 重現** | [B7-unreal-camera-port.md](B7-unreal-camera-port.md) | ✅ 相機1+2 驗收通過(UE 5.5,HFOV 91.49°/116.81° 零誤差):腳本 + 鎖檔 json ×2 + 圖解 SOP + 實戰踩坑;相機3 待做(B4–B6 紀錄在 `claude/b2-greybox-experiment-fgsc06` 分支) |
