...
|---|---|---|
| ![b9 tree original](images/b9-tree-original.webp) | ![b9 style source dead tree](images/b9-style-source-dead-tree.webp) | ![b9 bark texture ref](images/b9-bark-texture-ref.png) |

### 失敗 vs 成功

| 路線 1 ❌ 幾何滲漏(枯枝嫁接、樹幹被改形) | 路線 2 ❌ 整張重畫(樹冠重排、樹幹改形) | 路線 4 ✅ 成品(構圖保持、樹幹吃進樹皮畫法) |
|---|---|---|
| ![b9 fail geometry leak](images/b9-fail-geometry-leak.webp) | ![b9 fail full repaint](images/b9-fail-full-repaint.webp) | ![b9 restyle final](images/b9-restyle-final.webp) |
